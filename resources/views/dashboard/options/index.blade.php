...
@section('style')
    <link rel="stylesheet" type="text/css"
          href="{{asset('dashboard/vendors/css/tables/datatable/datatables.min.css')}}">
@endsection
                                        ...
                                        <table class="table table-striped table-bordered dom-jQuery-events dataTable"
                                            ...
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 126px;">{{__('dashboard.number')}}
                                                </th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1" aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending"
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a href="{{route('attributes.edit', $attribute->id)}}"
                                                           class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{__('dashboard.edit')}}
                                                            <i class="ft-edit"></i></a>
                                                        <button type="button" value="{{$attribute->id}}"
                                                                class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1"
                                                                data-toggle="modal" data-target="#{{$attribute->id}}">
                                                            <i class="la la-trash-o" style="font-size:15px"></i>
                                                            {{__('dashboard.delete.name')}}
                                                        </button>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="{{$attribute->id}}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div
                                                                        class="modal-header bg-danger border-0 no-border-top-radius">
                                                                        <h5 class="modal-title white"
                                                                            id="{{$attribute->id}}">{{__('dashboard.delete.delete_data')}}</h5>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                                data-dismiss="modal">{{__('dashboard.delete.close')}}</button>
                                                                        <form
                                                                            ...
                                                                            @method('delete')
                                                                            <button
                                                                                class="btn btn-danger">{{__('dashboard.delete.ok_delete')}}</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
...
@section('script')
    ...
    <script src="{{asset('dashboard/js/scripts/tables/datatables/datatable-advanced.js')}}"
            type="text/javascript"></script>
@endsection
