                ...
                <span class="mr-1">Hello,
                  ...
                  <img src="{{asset('dashboard/images/portrait/small/avatar-s-19.png')}}" alt="avatar"><i></i></span>
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
                                                                           aria-haspopup="true" aria-expanded="false"><i class="@if(app()->getLocale() == 'ar') flag-icon flag-icon-eg @else flag-icon flag-icon-gb @endif"></i><span class="selected-language"></span></a>
                            <div class="dropdown-menu" style="margin: 0 -80px;" aria-labelledby="dropdown-flag">
