<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">{{__('dashboard.attributes.title')}}</span><span class="badge badge badge-info badge-pill float-right mr-2">{{\App\Models\Attribute::count()}}</span></a>
                <ul class="menu-content" style="">
                    <li class=""><a class="menu-item" href="{{route('attributes.index')}}" data-i18n="nav.navbars.nav_light">{{__('dashboard.attributes.view_all')}}</a>
                    </li>
                    <li class=""><a class="menu-item" href="{{route('attributes.create')}}" data-i18n="nav.navbars.nav_dark">{{__('dashboard.attributes.create')}}</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item has-sub"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">{{__('dashboard.options.title')}}</span><span class="badge badge badge-info badge-pill float-right mr-2">{{\App\Models\Option::count()}}</span></a>
                <ul class="menu-content" style="">
                    <li class=""><a class="menu-item" href="{{route('options.index')}}" data-i18n="nav.navbars.nav_light">{{__('dashboard.options.view_all')}}</a>
                    </li>
                    <li class=""><a class="menu-item" href="{{route('options.create')}}" data-i18n="nav.navbars.nav_dark">{{__('dashboard.options.create')}}</a>
                    </li>
                </ul>
            </li>
        </ul>
