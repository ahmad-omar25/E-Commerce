...
@section('title', (__('dashboard.subCategories.title')))
@section('content')
    <style>
        .table th, .table td {
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{__('dashboard.subCategories.title')}}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('dashboard.home')}}</a>
                        </li>
                        <li class="breadcrumb-item active">{{__('dashboard.subCategories.title')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($categories as $index=>$category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('sub_categories.edit', $category->id)}}" class="btn btn-primary btn-sm">{{__('dashboard.edit')}}<i class="ft-edit"></i></a>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form action="{{route('sub_categories.destroy', $category->id)}}" method="POST" class="d-inline-block">
                                                                            @csrf
                                                                            @method('delete')
