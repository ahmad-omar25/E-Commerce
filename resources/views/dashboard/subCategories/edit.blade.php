...
@section('title', (__('dashboard.subCategories.edit')) . $category->name)
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{__('dashboard.subCategories.edit') . $category->name}}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('dashboard.home')}}</a></li>
                        <li class="breadcrumb-item"><a href="{{route('main_categories.index')}}">{{__('dashboard.subCategories.title')}}</a></li>
                        <li class="breadcrumb-item active">{{__('dashboard.subCategories.edit') . $category->name}}</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12 mb-2">
                                                ...
                                                <label id="{{$input}}" class="file center-block">
                                                    <input type="file" value="{{$category->image}}" name="{{$input}}" id="file">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mt-1">
                                                    <input type="checkbox" value="1" name="is_active" id="" class="" data-color="success" @if($category -> is_active == 1)checked @endif/>
