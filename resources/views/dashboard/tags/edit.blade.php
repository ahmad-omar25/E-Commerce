...
@section('title', (__('dashboard.tags.edit')) . $tag->name)
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{__('dashboard.tags.edit') . $tag->name}}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__('dashboard.tags.edit') . $tag->name}}</li>
                    </ol>
                </div>
            </div>
        </div>
